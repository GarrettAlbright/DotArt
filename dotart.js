    ...
    reader.addEventListener('load', function(e) {
      ...
      image.addEventListener('load', function(e) {
        ...
        do {
          ...
          DotArt.cellRows = Math.ceil(image.height / cellHeight);
          DotArt.cellColumns = Math.ceil(image.width / cellWidth);
        ...
        canvasContext.drawImage(image, 0, 0, DotArt.targetWidth, DotArt.targetHeight);
